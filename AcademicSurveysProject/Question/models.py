...
class Question(models.Model):
    ...
    survey = models.ForeignKey(Survey, null=True, related_name="questions", on_delete=models.CASCADE)
    template = models.ForeignKey(Template, null=True, related_name="questions", on_delete=models.CASCADE)
